...
//       while (currentDate < endTime) {
//         // FIX: Use toLocaleTimeString for hours/minutes
//         let formattedTime = currentDate.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });
...
//               >
//                 {/* Fallback logic: If timeSlot is empty for today, calculate day/date from today + index */}
//                 <p>{item[0] ? daysOfWeek[item[0].datetime.getDay()] : daysOfWeek[(new Date().getDay() + index) % 7]}</p>
//                 <p>{item[0] ? item[0].datetime.getDate() : (new Date().getDate() + index)}</p>
//               </div>
//             ))
//           }
//         </div>
